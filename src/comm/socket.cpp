...
socket::socket(domain const domain, type const type) noexcept
...
socket::socket(domain const domain, type const type,
               int const descriptor) noexcept
...
socket::socket(socket &&other) noexcept
    : domain_{other.domain_}, type_{other.type_}, descriptor_{
                                                      other.descriptor_}
{
...
socket::domain
socket::comm_domain() const noexcept
{
    return domain_;
}

socket::type
socket::socket_type() const noexcept
{
    return type_;
}
